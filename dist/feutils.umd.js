(function (global, factory) {
  ...
  function animation(_ref) {
    ...
    var value = from;
    var start = Date.now();
    var speed = (to - from) / duration; // 让value值变化一点
  ...
  function currying(fn) {
    ...
    if (args.length >= fn.length) {
      ...
      return function () {
        ...
        return currying.apply(void 0, [fn].concat(args, args2));
      };
    }
  ...
  function generateDeviceId$1() {
    var nav = window.navigator;
    var screen = window.screen;
    var deviceId = nav.mimeTypes.length;
    Object.values(navigator.mimeTypes).forEach(function (mime) {
      return deviceId += mime.type;
    });
  ...
  */
  ...
  function mathToFixed$1(value, precision) {
    return format(value, {
      notation: 'fixed',
      precision: precision
    });
  ...
  function maskStr$1() {
    ...
    var beginLen = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 4;
    ...
    if (str && str.length > beginLen + endLen) {
      var begin = str.substring(0, beginLen);
      var end = str.substring(str.length - endLen);
  ...
  exports.generateDeviceId = generateDeviceId$1;
  exports.isLoadedScript = isLoadedScript$1;
  exports.loadScript = loadScript$1;
  exports.lunhCheck = lunhCheck$1;
  exports.maskStr = maskStr$1;
  exports.mathAdd = mathAdd$1;
  exports.mathDivide = mathDivide$1;
  exports.mathMultiply = mathMultiply$1;
  exports.mathSubtract = mathSubtract$1;
  exports.mathToFixed = mathToFixed$1;
