(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.feutils = {}));
  ...
  function generateDeviceId() {
    ...
    Object.values(navigator.mimeTypes).forEach(function (p) {
      return deviceId += p.type;
    });
    deviceId += nav.userAgent.replace(/\D+/g, ''); //Only use digits

    deviceId += nav.plugins.length;
    Object.values(navigator.plugins).forEach(function (p) {
      return deviceId += p.filename;
    });
   ...
   * @returns {boolean}
   */
  function lunhCheck(str) {
    var sumDigit = function sumDigit(c) {
      return c < 10 ? c : sumDigit(Math.trunc(c / 10) + c % 10);
    };

    return str.split('').reverse().map(Number).map(function (c, i) {
      return i % 2 !== 0 ? sumDigit(c * 2) : c;
  ...
  */
  ...
  var createNumber = /* #__PURE__ */factory(name$z, dependencies$z, _ref => {
    var {
      typed
    } = _ref;
  ...
  var createBignumber = /* #__PURE__ */factory(name$y, dependencies$y, _ref => {
    var {
      typed,
      BigNumber
    } = _ref;
  ...
  var name$x = 'fraction';
  var dependencies$x = ['typed', 'Fraction'];
  var createFraction = /* #__PURE__ */factory(name$x, dependencies$x, _ref => {
    var {
      typed,
      Fraction
    } = _ref;
  ...
  var name$w = 'matrix';
  var dependencies$w = ['typed', 'Matrix', 'DenseMatrix', 'SparseMatrix'];
  var createMatrix = /* #__PURE__ */factory(name$w, dependencies$w, _ref => {
    var {
      typed,
      Matrix,
      DenseMatrix,
  ...
  var name$v = 'unaryMinus';
  var dependencies$v = ['typed'];
  var createUnaryMinus = /* #__PURE__ */factory(name$v, dependencies$v, _ref => {
    var {
      typed
    } = _ref;
  ...
  var createAbs = /* #__PURE__ */factory(name$u, dependencies$u, _ref => {
    var {
      typed
    } = _ref;
  ...
  var name$t = 'addScalar';
  var dependencies$t = ['typed'];
  var createAddScalar = /* #__PURE__ */factory(name$t, dependencies$t, _ref => {
    var {
      typed
    } = _ref;
  ...
  var name$s = 'algorithm11';
  var dependencies$s = ['typed', 'equalScalar'];
  var createAlgorithm11 = /* #__PURE__ */factory(name$s, dependencies$s, _ref => {
    var {
      typed,
      equalScalar
    } = _ref;
  ...
  var name$r = 'algorithm14';
  var dependencies$r = ['typed'];
  var createAlgorithm14 = /* #__PURE__ */factory(name$r, dependencies$r, _ref => {
    var {
      typed
    } = _ref;
  ...
  var name$q = 'algorithm01';
  var dependencies$q = ['typed'];
  var createAlgorithm01 = /* #__PURE__ */factory(name$q, dependencies$q, _ref => {
    var {
      typed
    } = _ref;
  ...
  var name$p = 'algorithm04';
  var dependencies$p = ['typed', 'equalScalar'];
  var createAlgorithm04 = /* #__PURE__ */factory(name$p, dependencies$p, _ref => {
    var {
      typed,
      equalScalar
    } = _ref;
  ...
  var name$o = 'algorithm10';
  var dependencies$o = ['typed', 'DenseMatrix'];
  var createAlgorithm10 = /* #__PURE__ */factory(name$o, dependencies$o, _ref => {
    var {
      typed,
      DenseMatrix
    } = _ref;
  ...
  var name$n = 'algorithm13';
  var dependencies$n = ['typed'];
  var createAlgorithm13 = /* #__PURE__ */factory(name$n, dependencies$n, _ref => {
    var {
      typed
    } = _ref;
  ...
  var createAlgorithm03 = /* #__PURE__ */factory(name$m, dependencies$m, _ref => {
    var {
      typed
    } = _ref;
  ...
  var createAlgorithm05 = /* #__PURE__ */factory(name$l, dependencies$l, _ref => {
    var {
      typed,
      equalScalar
    } = _ref;
  ...
  var name$k = 'algorithm12';
  var dependencies$k = ['typed', 'DenseMatrix'];
  var createAlgorithm12 = /* #__PURE__ */factory(name$k, dependencies$k, _ref => {
    var {
      typed,
      DenseMatrix
    } = _ref;
  ...
  var createFormat = /* #__PURE__ */factory(name$c, dependencies$c, _ref => {
    var {
      typed
    } = _ref;
  ...
  var name$b = 'numeric';
  var dependencies$b = ['number', '?bignumber', '?fraction'];
  var createNumeric = /* #__PURE__ */factory(name$b, dependencies$b, _ref => {
    var {
      number: _number,
      bignumber,
      fraction
  ...
  var name$a = 'divideScalar';
  var dependencies$a = ['typed', 'numeric'];
  var createDivideScalar = /* #__PURE__ */factory(name$a, dependencies$a, _ref => {
    var {
      typed,
      numeric
    } = _ref;
  ...
  var name$9 = 'smaller';
  var dependencies$9 = ['typed', 'config', 'matrix', 'DenseMatrix'];
  var createSmaller = /* #__PURE__ */factory(name$9, dependencies$9, _ref => {
    var {
      typed,
      config,
      matrix,
  ...
  var name$7 = 'FibonacciHeap';
  var dependencies$7 = ['smaller', 'larger'];
  var createFibonacciHeapClass = /* #__PURE__ */factory(name$7, dependencies$7, _ref => {
    var {
      smaller,
      larger
    } = _ref;
  ...
  var name$6 = 'Spa';
  var dependencies$6 = ['addScalar', 'equalScalar', 'FibonacciHeap'];
  var createSpaClass = /* #__PURE__ */factory(name$6, dependencies$6, _ref => {
    var {
      addScalar,
      equalScalar,
      FibonacciHeap
  ...
  var name$5 = 'add';
  var dependencies$5 = ['typed', 'matrix', 'addScalar', 'equalScalar', 'DenseMatrix', 'SparseMatrix'];
  var createAdd = /* #__PURE__ */factory(name$5, dependencies$5, _ref => {
    var {
      typed,
      matrix,
      addScalar,
  ...
  function mathAdd(a, b) {
    return format(add(bignumber(a), bignumber(b))) * 1;
  } // -

  function mathSubtract(a, b) {
    return format(subtract(bignumber(a), bignumber(b))) * 1;
  } // *

  function mathMultiply(a, b) {
    return format(multiply(bignumber(a), bignumber(b))) * 1;
  } // /

  function mathDivide(a, b) {
    return format(divide(bignumber(a), bignumber(b))) * 1;
  } // (144094.425).toFixed(2) === "144094.42" toFixed方法有误差
  // mathToFixed(144094.425,2) === "144094.43"

  function mathToFixed(value, precision) {
    return format(value, {
      notation: 'fixed',
      precision: precision
    });
